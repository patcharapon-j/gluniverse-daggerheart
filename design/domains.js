...
export const icon  = slug => load(`/design/assets/domains/${slug}.svg`);
export const glyph = name => load(`/design/assets/types/${name}.svg`);
...
export const clazz = name => load(`/design/assets/classes/${name}.svg`);
