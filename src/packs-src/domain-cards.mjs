 ...
 *
 * The 189 corebook domain cards, extracted from
...
export default [
  ...
  },
  {
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Power Push:</b> Make a Spellcast Roll against a target within Melee range. On a success, they’re knocked back to Far range and take d10+2 magic damage using your Proficiency.\n\n<b>Tava’s Armor:</b> Spend a Hope to give a target you can touch a +1 bonus to their Armor Score until their next rest or you cast Tava’s Armor again.\n\n<b>Ice Spike:</b> Make a Spellcast Roll (12) to summon a large ice spike within Far range. If you use it as a weapon, make the Spellcast Roll against the target’s Difficulty instead. On a success, deal d6 physical damage using your Proficiency.",
  },
  {
    name: "Book of Illiat",
    domain: "codex",
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Slumber:</b> Make a Spellcast Roll against a target within Very Close range. On a success, they’re Asleep until they take damage or the GM spends a Fear on their turn to clear this condition.\n\n<b>Arcane Barrage:</b> Once per rest, spend any number of Hope and shoot magical projectiles that strike a target of your choice within Close range. Roll a number of d6s equal to the Hope spent and deal that much magic damage to the target.\n\n<b>Telepathy:</b> Spend a Hope to open a line of mental communication with one target you can see. This connection lasts until your next rest or you cast Telepathy again.",
  },
  {
    name: "Deathrun",
    domain: "bone",
  ...
  },
  {
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Wild Flame:</b> Make a Spellcast Roll against up to three adversaries within Melee range. Targets you succeed against take 2d6 magic damage and must mark a Stress as flames erupt from your hand.\n\n<b>Magic Hand:</b> You conjure a magical hand with the same size and strength as your own within Far range.\n\n<b>Mysterious Mist:</b> Make a Spellcast Roll (13) to cast a temporary thick fog that gathers in a stationary area within Very Close range. The fog heavily obscures this area and everything in it.",
  },
  {
    name: "Book of Sitil",
    domain: "codex",
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Adjust Appearance:</b> You magically shift your appearance and clothing to avoid recognition.\n\n<b>Parallela:</b> Spend 2 Hope to cast this spell on yourself or an ally within Close range. The next time the target makes an attack, they can hit an additional target within range that their attack roll would succeed against. You can only hold this spell on one creature at a time.\n\n<b>Illusion:</b> Make a Spellcast Roll (14). On a success, create a temporary visual illusion no larger than you within Close range that lasts for as long as you look at it. It holds up to scrutiny until an observer is within Melee range.",
  },
  {
    name: "Swift Step",
    domain: "bone",
  ...
  },
  {
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Runic Lock:</b> Make a Spellcast Roll (15) on an object you’re touching that can close (such as a lock, chest, or box). Once per rest on a success, you can lock the object so it can only be opened by creatures of your choice. Someone with access to magic and an hour of time to study the spell can break it.\n\n<b>Arcane Door:</b> When you have no adversaries within Melee range, make a Spellcast Roll (13). On a success, spend a Hope to create a portal from where you are to a point within Far range you can see. It closes once a creature has passed through it.\n\n<b>Reveal:</b> Make a Spellcast Roll. If there is anything magically hidden within Close range, it is revealed.",
  },
  {
    name: "Book of Korvax",
    domain: "codex",
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Levitation:</b> Make a Spellcast Roll to temporarily lift a target you can see up into the air and move them within Close range of their original position.\n\n<b>Recant:</b> Spend a Hope to force a target within Melee range to make a Reaction Roll (15). On a failure, they forget the last minute of your conversation.\n\n<b>Rune Circle:</b> Mark a Stress to create a temporary magical circle on the ground where you stand. All adversaries within Melee range, or who enter Melee range, take 2d12+4 magic damage and are knocked back to Very Close range.",
  },
  {
    name: "Book of Norai",
    domain: "codex",
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Mystic Tether:</b> Make a Spellcast Roll against a target within Far range. On a success, they’re temporarily Restrained and must mark a Stress. If you target a flying creature, this spell grounds and temporarily Restrains them.\n\n<b>Fireball:</b> Make a Spellcast Roll against a target within Very Far range. On a success, hurl a sphere of fire toward them that explodes on impact. The target and all creatures within Very Close range of them must make a Reaction Roll (13). Targets who fail take d20+5 magic damage using your Proficiency. Targets who succeed take half damage.",
  },
  {
    name: "Book of Exota",
    domain: "codex",
  ...
  },
  {
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Arcane Deflection:</b> Once per long rest, spend a Hope to negate the damage of an attack targeting you or an ally within Very Close range.\n\n<b>Time Lock:</b> Target an object within Far range. That object stops in time and space exactly where it is until your next rest. If a creature tries to move it, make a Spellcast Roll against them to maintain this spell.\n\n<b>Wall of Flame:</b> Make a Spellcast Roll (15). On a success, create a wall of magical flame between two points within Far range. All creatures in its path must choose a side to be on, and anything that subsequently passes through the wall takes 4d10+3 magic damage.",
  },
  {
    name: "Manifest Wall",
    domain: "codex",
  ...
  },
  {
    ...
    cardType: "grimoire",
    recall: 0,
    text: "<b>Pass Through:</b> Make a Spellcast Roll (13). Once per rest on a success, you and all creatures touching you can pass through a wall or door within Close range. The effect ends once everyone is on the other side.\n\n<b>Plane Gate:</b> Make a Spellcast Roll (14). Once per long rest on a success, open a gateway to a location in another dimension or plane of existence you’ve been to before. This gateway lasts until your next rest.",
  },
  {
    name: "Codex-Touched",
    domain: "codex",
  ...
  },
  {
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Memory Delve:</b> Make a Spellcast Roll against a target within Far range. On a success, peer into the target’s mind and ask the GM a question. The GM describes any memories the target has pertaining to the answer.\n\n<b>Shared Clarity:</b> Once per long rest, spend a Hope to choose two willing creatures. When one of them would mark Stress, they can choose between the two of them who marks it. This spell lasts until their next rest.",
  },
  {
    name: "Safe Haven",
    domain: "codex",
  ...
  },
  {
    ...
    cardType: "grimoire",
    recall: 4,
    text: "<b>Transform:</b> Make a Spellcast Roll (15). On a success, transform into an inanimate object no larger than twice your normal size. You can remain in this shape until you take damage.\n\n<b>Eternal Enervation:</b> Once per long rest, make a Spellcast Roll against a target within Close range. On a success, they become permanently Vulnerable. They can’t clear this condition by any means.",
  },
  {
  ...
  },
  {
    ...
    cardType: "grimoire",
    recall: 2,
    text: "<b>Timejammer:</b> Make a Spellcast Roll (18). On a success, time temporarily slows to a halt for everyone within Far range except for you. It resumes the next time you make an action roll that targets another creature.\n\n<b>Magic Immunity:</b> Spend 5 Hope to become immune to magic damage until your next rest.",
  },
  {
  ...
  },
  {
    ...
    cardType: "ability",
    recall: 1,
    text: "As an additional downtime move you can choose, roll a d6 to see what you forage. Work with the GM to describe it and add it to your inventory as a consumable. Your party can carry up to five foraged consumables at a time. 1. A unique food (Clear 2 Stress) 2. A beautiful relic (Gain 2 Hope) 3. An arcane rune (+2 to a Spellcast\n\nRoll) 4. A healing vial (Clear 2 Hit Points) 5. A luck charm (Reroll any die) 6. Choose one of the options above.",
  },
  {
    name: "Sage-Touched",
    domain: "sage",
